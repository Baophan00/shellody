      ...
      <main className="pb-32 pt-16">
        ...
        <section className="mx-auto max-w-4xl px-6">
          <Tabs defaultValue="feed">
            <div className="flex items-center justify-between mb-8 border-b border-border pb-0">
              <TabsList className="bg-transparent p-0 h-auto rounded-none gap-8">
                <TabsTrigger
                  value="feed"
                  className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent px-0 pb-3 text-muted-foreground data-[state=active]:text-foreground text-sm font-medium uppercase tracking-widest"
                >
                  Feed
                </TabsTrigger>
                <TabsTrigger
              ...
              <span className="text-xs text-muted-foreground pb-3">Sorted by newest</span>
            </div>
