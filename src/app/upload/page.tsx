  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-10">
      ...
      <p className="text-zinc-600 text-sm mb-8">
        After uploading, go to your profile to make it public on the feed.
      </p>
      ...
      <div
        ...
        className={`relative border-2 border-dashed rounded-2xl p-8 text-center mb-6 transition-colors ${
      ...
      >
        ...
        {file ? (
          <div className="flex flex-col items-center gap-2">
            <div className="w-12 h-12 rounded-xl bg-violet-500/20 flex items-center justify-center mb-1">
